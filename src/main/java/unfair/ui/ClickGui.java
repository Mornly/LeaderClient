...
public class ClickGui extends GuiScreen {
    ...
    public void drawScreen(int x, int y, float p) {
        ...
        this.drawCenteredString(this.fontRendererObj, "L", wd + 1 - w_c, h - 25, hudColor6);
        this.drawCenteredString(this.fontRendererObj, "e", wd - w_c, h - 15, hudColor5);
        this.drawCenteredString(this.fontRendererObj, "a", wd - w_c, h - 5, hudColor4);
        this.drawCenteredString(this.fontRendererObj, "d", wd - w_c, h + 5, hudColor3);
        this.drawCenteredString(this.fontRendererObj, "e", wd - w_c, h + 15, hudColor2);
